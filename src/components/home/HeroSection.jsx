...
export default function HeroSection() {
  return (
    <section
      className="relative bg-cover bg-center h-screen flex items-center justify-center text-center text-white -mt-20"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-12 px-4">
        ...
        <div className="flex flex-col items-center gap-4">
          <h1 className="text-6xl font-bold font-space-grotesk text-white-background2">
            Explore Biodiversity
          </h1>
          <p className="text-xl max-w-2xl text-white-background1">
            Discover and contribute to wildlife in Vietnam
          </p>
        </div>
        {/* Search bar */}
        <div className="bg-black/60 border border-white/40 rounded-full flex items-center p-2 w-full max-w-lg">
          <input
            type="text"
            placeholder="Search species, locations, etc..."
            className="bg-transparent focus:outline-none text-white-background1 placeholder-gray-400 grow px-4"
          />
          <button className="bg-back-text text-white-background2 border border-gray rounded-full p-3 hover:bg-gray-dark hover:border-white transition-all duration-300 cursor-pointer">
            <Search />
          </button>
        </div>
